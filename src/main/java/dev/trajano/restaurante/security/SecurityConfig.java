package dev.trajano.restaurante.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PUT, "/garcons/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/garcons/**").hasRole("ADMIN")

                        .requestMatchers(HttpMethod.POST, "/produto/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/produto/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/produto/**").hasRole("ADMIN")
                        .requestMatchers("/pedidos/**").hasAnyRole("ADMIN", "GARCOM")
